      ...
      <Container>
        ...
        <div className="mx-auto mt-16 max-w-5xl border-t border-white/8">
          {content.steps.map((step) => (
            <article
              key={step.id}
              className="grid gap-5 text-center lg:text-start border-b border-white/8 py-6 sm:py-8 lg:grid-cols-[120px_minmax(0,240px)_minmax(0,1fr)] lg:gap-8 lg:py-10"
            >
              <div className="">
              ...
              <div>
                <p className="lg:max-w-[48ch] text-sm leading-7 text-muted-foreground sm:text-base sm:leading-8">
                  {step.description}
                </p>
              </div>
            </article>
