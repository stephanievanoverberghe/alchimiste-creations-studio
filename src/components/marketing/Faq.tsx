                ...
                return (
                  ...
                  >
                    ...
                    <button
                      ...
                      className="flex w-full cursor-pointer items-start gap-4 px-6 py-5 text-left transition-all duration-300 ease-out sm:px-8 sm:py-6"
                    >
                      ...
                      <span
                        className={cn(
                          'flex h-10 w-10 shrink-0 cursor-pointer items-center justify-center rounded-full border border-white/10 bg-white/4 text-foreground/70 transition-all duration-300 ease-out',
                          isOpen
